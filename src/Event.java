...
class Event {
    ...
    public void organizeEvent(int choice){
        ...
        HandleComplementaryPasses CompPassess = new HandleComplementaryPasses();
        ...
        switch(choice){
            ...
            case 2:
                ...
                for(int i=0;i<num; i++){
                    ...
                    String seat= reader.nextLine();//A12,B22

                    Attendee newAttendee = new Attendee(name, gender, email, age, seat);
                    eventAttendees.add(newAttendee);
                    //seatDetails.put(seat, newAttendee);  // add to the hashmap
                    setSeatDetails(seat, newAttendee);
                }
                System.out.println("\n All the attendees were added successfully to the list of attendee");
                break;
            case 3:
            ...
            case 6:
                ...
                break;
            case 7:
                CompPassess.handleComplementaryPasses();
                break;
            case 8:
                Performances.handlePerformances();
                break;
            case 9:
                System.out.println("Enter the seat number you want to find: ");
                String seatNum = reader.nextLine();
                for(Attendee attendee :eventAttendees){
                    if(attendee.getSeatNo().equals(seatNum)){
